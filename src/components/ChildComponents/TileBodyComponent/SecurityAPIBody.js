               ...
               <Box sx={{display:'flex', flexDirection:'row', height:'400px' }}>
                      <Grid container direction="row" >
                          <Grid item container xs={2} justifyContent="center" alignItems="center">
                              <Box >
                                  {(toggleBackArrow) && <img src={backwardImg} alt='backward' onClick={()=>_backwardClick(data.securityControl)}/>}
                              </Box>
                          </Grid>
                          ...
                          <Grid item xs={2} container xs={2} justifyContent="center" alignItems="center">
                              <Box > 
                                  {(toggleForArrow ) && <img src={forwardImg} alt='forward' onClick={()=>_forwardClick(data.securityControl)}/>}
                              </Box>
